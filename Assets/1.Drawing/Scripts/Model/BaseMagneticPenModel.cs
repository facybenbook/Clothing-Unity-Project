...
namespace Clothing.Drawing
{
    ...
    public class BaseMagneticPenModel : BasePenModel
    {
        ...
        public Texture2D Photo
        {
            get
            {
                ...
                if ( _photo == null )
                {
                    ...
                    _photo = Resources.Load<Texture2D> ( "Cat" );// ( "TocaMini" );//
                    int miplevel =1;
                    int n = 1 << miplevel;
                    Width = _photo.width / n;
                    Height = _photo.height / n;
                    Caches = _photo.GetPixels ( miplevel );// new Color32 [ Rows * Cols ];
                }
                return _photo;
            }
        }
        ...
        private Vector2 CalcUV ( int index, int w, int h )
        {
            int x = index % w;
            int y = index / w;
